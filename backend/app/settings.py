...
class Settings(BaseModel):
    ...
    mmr_lambda: float = float(os.getenv("MMR_LAMBDA", "0.72"))
    retrieval_score_floor: float = float(os.getenv("RETRIEVAL_SCORE_FLOOR", "0.18"))
    mask_sensitive_output: bool = os.getenv("MASK_SENSITIVE_OUTPUT", "true").lower() == "true"
